...
class AnimacionParticulas extends StatefulWidget {
  ...
  const AnimacionParticulas({Key? key, required this.numberOfParticles}) : super(key: key);
...
class _AnimacionParticulasState extends State<AnimacionParticulas> with WidgetsBindingObserver {
  ...
  //CHECADO HASTA ESTE PUNTO Y BIEN
...
class ParticlePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size){
    ...
    for(var particle in particles) {
      ...
      final MultiTweenValues<ParticleOffsetProps> animation = particle.tween.transform(progress);
